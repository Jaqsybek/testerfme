...
function displayCurrentQuestion() {
  ...
  variants.forEach((variant, varIndex) => {
    ...
    input.addEventListener('change', function() {
      ...
      },1212121212121212121221212121212121212121212121212121212121212121111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111 ); // Задержка не в 6 секунд перед переходом сечас просто костлыь 
    });
